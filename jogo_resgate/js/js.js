...
//Função que movimenta o fundo do jogo
	...
	function movejogador() {
		...
		if (jogo.pressionou[TECLA.A] || jogo.pressionou[TECLA.leftArrow]) {
		...
		if (jogo.pressionou[TECLA.D] || jogo.pressionou[TECLA.rightArrow]) {
			var left = parseInt($("#jogador").css("left"));
			$("#jogador").css("left",left+10);
...
function reposicionaInimigo2() {
	...
	function gameOver() {
		...
		$("#fim").html("<h1> Game Over </h1><p>Sua pontuação foi: " + pontos + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()><button><h3>Jogar Novamente</h3</button></div>");
